...
Template.__define__("__dynamic", (function() {                                                       // 2
  var view = this;                                                                                   // 3
  return [ Blaze.View(function() {                                                                   // 4
    return Spacebars.mustache(view.lookup("checkContext"));                                          // 5
  }), "\n  ", Blaze.If(function() {                                                                  // 6
    return Spacebars.call(view.lookup("dataContextPresent"));                                        // 7
  }, function() {                                                                                    // 8
    return [ "\n    ", Spacebars.include(view.lookupTemplate("__dynamicWithDataContext")), "\n  " ]; // 9
  }, function() {                                                                                    // 10
    return [ "\n    \n    ", Spacebars.TemplateWith(function() {                                     // 11
      return {                                                                                       // 12
        template: Spacebars.call(view.lookup("template")),                                           // 13
        data: Spacebars.call(view.lookup(".."))                                                      // 14
      };                                                                                             // 15
    }, function() {                                                                                  // 16
      return Spacebars.include(view.lookupTemplate("__dynamicWithDataContext"));                     // 17
    }), "\n  " ];                                                                                    // 18
  }) ];                                                                                              // 19
}));                                                                                                 // 20
                                                                                                     // 21
Template.__define__("__dynamicWithDataContext", (function() {                                        // 22
  var view = this;                                                                                   // 23
  return Spacebars.With(function() {                                                                 // 24
    return Spacebars.dataMustache(view.lookup("chooseTemplate"), view.lookup("template"));           // 25
  }, function() {                                                                                    // 26
    return [ "\n    ", Spacebars.TemplateWith(function() {                                           // 27
      return Spacebars.call(Spacebars.dot(view.lookup(".."), "data"));                               // 28
    }, function() {                                                                                  // 29
      return Spacebars.include(view.lookupTemplate(".."));                                           // 30
    }), "    \n  " ];                                                                                // 31
  });                                                                                                // 32
}));                                                                                                 // 33
                                                                                                     // 34
...
//# sourceMappingURL=8717c3bee1160f47e7a46ea4e1bd0796f944cad8.map
